 ...
 */
typedef NS_ENUM(NSUInteger,VeridiumAuthResult) {
...
-(void) export:(id<VeridiumBiometricExportConfig> _Nonnull) settings
                         onSuccess:(biometricFullVectorBlock _Nonnull) onSuccess
                            onFail:(voidBlock _Nonnull) onFail
                          onCancel:(voidBlock _Nonnull) onCancel
                           onError:(errorBlock _Nonnull) onError;

/*!
 Setup export with a licence
 
 @param license that includes export
 */
-(VeridiumLicenseStatus *_Nullable)setupWithLicence:(NSString *_Nonnull)licence;
