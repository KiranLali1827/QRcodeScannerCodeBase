...
-(void)authenticateOfflineForProfile:(VeridiumProfileData* _Nonnull) profile
                                    completion:(void(^ _Nonnull)(VeridiumAggregatedAuthResult* _Nonnull result, NSError* _Nullable error)) completion;

-(void)authenticateForUpdateForProfile:(VeridiumProfileData* _Nonnull) profile
                                    completion:(void(^ _Nonnull)(VeridiumAggregatedAuthResult* _Nonnull result, NSError* _Nullable error)) completion;

-(void)authenticateAndRemoveDeviceWithCompletion: (void(^ _Nonnull)(VeridiumAggregatedAuthResult* _Nonnull result, NSError* _Nullable error)) completion;
