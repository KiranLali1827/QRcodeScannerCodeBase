...
static NSString* const USER_SETTING_IS_AUTHENTICATION_CONTEXT_ENABLED = @"isAuthenticationContextEnabled";
static NSString* const USER_SETTING_IS_WAIT_FOR_LOCATION_ENABLED = @"isWaitForLocationEnabled";
static NSString* const USER_SETTING_LOCATION_ACCURACY = @"locationAccuracy";
static NSString* const SERVER_SETTING_LOCATION_ACCURACY = @"location-accuracy-threshold";
static NSString* const USER_SETTING_LOCATION_WAIT_TIME = @"isLocationWaitTime";
